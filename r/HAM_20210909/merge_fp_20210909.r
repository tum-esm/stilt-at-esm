...
rdf <- readRDS('HAM_20210909_receptors_ERA5.rds')
project <- 'STILT_HAM/HAM_20210909_ERA5_column_bw14'
out_file <- 'HAM_20210909_column_ERA5_bw14.nc'

stilt_wd <- file.path('/gpfs/scratch/pr48ze/ga62kuy2', project)
output_wd <- file.path(stilt_wd, 'by-id')
fp_wd <- file.path(stilt_wd,'footprints')
